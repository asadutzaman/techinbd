          ...
          <div className="col-lg-5 mb-30">
            <div id="product-carousel" className="carousel slide" data-ride="carousel">
              <div className="carousel-inner bg-light">
                {[1,2,3,4].map((i, idx) => (
                  <div key={i} className={`carousel-item${idx === 0 ? ' active' : ''}`}>
                    <img className="w-100 h-100" src={`/img/product-${i}.jpg`} alt="Product" />
                  </div>
                ))}
              </div>
          ...
          <div className="col">
            <div className="bg-light p-30">
              <div className="nav nav-tabs mb-4">
                <a className={`nav-item nav-link text-dark${tab==='description'?' active':''}`} data-toggle="tab" href="#tab-pane-1" onClick={e=>{e.preventDefault();setTab('description')}}>Description</a>
                <a className={`nav-item nav-link text-dark${tab==='information'?' active':''}`} data-toggle="tab" href="#tab-pane-2" onClick={e=>{e.preventDefault();setTab('information')}}>Information</a>
                <a className={`nav-item nav-link text-dark${tab==='reviews'?' active':''}`} data-toggle="tab" href="#tab-pane-3" onClick={e=>{e.preventDefault();setTab('reviews')}}>Reviews (0)</a>
              </div>
              <div className="tab-content">
                <div className={`tab-pane fade${tab==='description'?' show active':''}`} id="tab-pane-1">
                ...
                <div className={`tab-pane fade${tab==='information'?' show active':''}`} id="tab-pane-2">
                ...
                <div className={`tab-pane fade${tab==='reviews'?' show active':''}`} id="tab-pane-3">
                  <div className="row">
                    <div className="col-md-6">
        ...
        <div className="row px-xl-5">
          <div className="col">
            <div className="owl-carousel related-carousel">
              {[1,2,3,4].map(i => (
                <div key={i} className="product-item bg-light">
                  <div className="product-img position-relative overflow-hidden">
                    <img className="img-fluid w-100" src={`/img/product-${i}.jpg`} alt="" />
